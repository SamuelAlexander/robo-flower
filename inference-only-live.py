...
# Constants: These are the settings we use throughout the script
...
CLOSE_AREA_MULTIPLIER = 2.0  # We multiply the area of 'close' objects by this to give them priority
...
def main():
    """
    Main function to run the object detection on webcam feed.
    """
